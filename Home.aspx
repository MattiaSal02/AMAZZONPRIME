...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container marketing ">
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5">
                <img src="img/img1.jpg" style="width: 600px" />
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-5">
                <img src="img/img2.jpg" style="width: 500px" />
            </div>
            <div class="col-xxl-7">
                <h2 class="featurette-heading fw-normal lh-1">Amazon brings you the UEFA Champions League</h2>
                <p class="lead">Sign up today and watch live the top pick of Champions League on Wednesday exclusively on Prime Video, and highlights of all matches.</p>
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-xxl-7">
                <h2 class="featurette-heading fw-normal lh-1">Your favorite channels all in one place</h2>
                <p class="lead">With Prime Video Channels, members can subscribe to premium and specialty channels with no long-term commitments and no additional apps to download. Each subscription starts with a free trial, and you can cancel anytime.</p>
            </div>
            <div class="col-md-5">
                <img src="img/img3.jpg" style="width: 600px" />
            </div>
        </div>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
                <img src="img/img6.jpg" style="width: 500px" />
            </div>
        </div>
        ...
        <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
                <img src="img/img4.jpg" style="width: 500px" />
            </div>
        </div>
